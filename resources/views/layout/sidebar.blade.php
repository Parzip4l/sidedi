<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['wargas']) }}">
        <a href="{{ url('/wargas') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['']) }}">
        <a href="{{ url('/') }}" class="nav-link">
          ...
          <span class="link-title">Catatan Kependudukan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['']) }}">
        <a href="{{ url('/') }}" class="nav-link">
          <i class="link-icon" data-feather="folder"></i>
          <span class="link-title">Dokument Control</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['']) }}">
        <a href="{{ url('/') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['polling']) }}">
      ...
      <li class="nav-item {{ active_class(['settings']) }}">
        ...
        <i class="link-icon" data-feather="database"></i>
          <span class="link-title">App Details</span>
        </a>
      </li>
